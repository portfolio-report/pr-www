module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.sequelize.query(
        'INSERT INTO markets_new SELECT id, securityId, marketCode, currencyCode, firstPriceDate, lastPriceDate, symbol, 1 as updatePrices FROM markets'
      )
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.sequelize.query(
        'INSERT INTO markets_new SELECT id, securityId, marketCode, currencyCode, firstPriceDate, lastPriceDate, symbol FROM markets'
      )
